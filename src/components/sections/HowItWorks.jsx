    ...
    <section className="py-32 bg-surface-100 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10 max-w-6xl mx-auto">
          {/* Connector Line (Desktop only) - animated dash */}
          <div className="hidden md:block absolute top-[120px] left-[15%] right-[15%] h-px z-0 overflow-hidden">
            <div className="w-full h-full border-t-2 border-dashed border-surface-300 animate-[marquee_10s_linear_infinite]"></div>
          </div>
          ...
          >
            <motion.div className="w-64 h-64 bg-white rounded-full toss-shadow flex items-center justify-center p-8 mb-10 border border-surface-200"
          ...
          <motion.div 
            ...
            className="relative z-10 flex flex-col items-center text-center"
          >
            <motion.div className="w-64 h-64 bg-white rounded-full toss-shadow flex items-center justify-center p-8 mb-10 border border-brand-200"
              initial={{ scale: 0.5, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
              viewport={{ once: true }}
